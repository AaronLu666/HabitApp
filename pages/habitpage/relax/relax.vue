				...
				<u-popup v-model="show" mode="bottom" border-radius="14" width="500rpx" height="650px" :closeable="true">
					...
					<view style="padding: 50upx; text-align: center;">
						...
						<view style="text-align: left;">
							<view>Your evaluation of the quality of your sleep this time: perfect, keep it up!</view>
							<u-gap height="10" bg-color="#FFFFFF"></u-gap>
							<view>Your bedtime is late, so it's recommended that you go to bed before 00:00 daily!</view>
							<u-gap height="10" bg-color="#FFFFFF"></u-gap>
							<view>You are sleeping for a longer period of time, so it is advisable to set an alarm clock to control your sleep!</view>
							<u-gap height="10" bg-color="#FFFFFF"></u-gap>
						</view>
					</view>
				</u-popup>
				...
				return {
					...
					SleepData:{
						"ColumnStack": {
						        ...
						        "series": [{
						        "name": "sober",
						        "data": [20, 0, 0, 17, 5, 0, 24, 22, 40]
						         },{
						        "name": "deep",
						        "data": [10, 20, 13, 10, 15, 14, 6, 8, 2]
						         }, {
						        "name": "light",
